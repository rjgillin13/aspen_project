CREATE OR REPLACE PROCEDURE sp_phone_number() language plpgsql
AS $$
    ...
    (Select
     ...
     FROM
         (Select
          ...
          FROM
              (Select
                   b.value,b.type,srp.role_profile,up.user_id
               FROM
                   (Select borrower_id, phone_home as value, 'phone_home' as type FROM stg_borrower
                    UNION
                    Select borrower_id,phone_cell as value, 'phone_cell' as type FROM stg_borrower) b
